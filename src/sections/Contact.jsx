...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "askebirtadess@gmail.com",
    href: "askebirtadess@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+251987815155",
    href: "tel:++2519-87815155",
  },
  {
    icon: MapPin,
    label: "Location",
  ...
  return (
    <section className="py-32 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full ">
        ...
        <div className="absolute buttom-1/4 right-1/4 w-64 h-64 bg-highlight/5 blur-3xl "></div>
      </div>
      <div className="container mx-auto px-6 relative z-10">
        {/* section of header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span>Get In Touch</span>
          <h2 className=" text-4xl md:text-5xl font-bold mt-4 mb-6 aniamte-fade-in text-blue-700">
            Let's build{" "}
