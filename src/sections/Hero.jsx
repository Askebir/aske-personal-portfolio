  ...
  return (
    <section className="relative min-h-screen flex  items-center overflow-hidden ">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center ">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400 ">
              <span className="text-sm text-muted-forground">Follow Me:</span>
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                <img
                  ...
                  alt="Pedro Machado"
                  className="w-full aspet-[4/5] object-cover rounded-2xl"
                />
                {/* Floating badge */}
                ...
                {/* Stats Badge */}
                <div className="absolute -top4 -left-4 glass rounded-xl px-4 py-3 animate-float animation-delay-500">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-fade-in animation-delay-800">
        <a
          href="#about"
          className="flex flex-col items-center gap-2 text-muted-foreground  hover:text-primary-foreground cursor-pointer "
        >
          <span className="text-xs uppercase tracking-wider">Scroll</span>
          <FaChevronDown className="w-5 h-6 animate-bounce" />
        </a>
      </div>
    </section>
  );
